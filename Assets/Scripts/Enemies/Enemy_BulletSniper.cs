...
public class Enemy_BulletSniper : MonoBehaviour
{
    private GameObject player;
    private Rigidbody2D rb;

    private float speed = 30f;//szybkość pocisku

    private int damage = 65;//obrażenia pocisku

    private float timeAlive = 4.5f;//max czas lotu pocisku
    ...
    void Start()
    {
        ...
        rb.velocity = new Vector3(direction.x, direction.y).normalized  * speed;
